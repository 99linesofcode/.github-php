...
Simply copy the `.yaml` files you need into your projects `.github` folder. Unfortunately, GitHub doesn't traverse into submodules and we cannot pull these files in as a git submodule.
